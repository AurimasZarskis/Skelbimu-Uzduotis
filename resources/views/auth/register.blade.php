...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Registruotis</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" aria-label="Registruotis">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">Pakartokite slaptažodį</label>
